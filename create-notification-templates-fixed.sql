-- =====================================================
-- PLANTILLAS PREDEFINIDAS PARA NOTIFICACIONES PROGRAMADAS (CORREGIDO)
-- =====================================================

-- Primero, actualizar el enum de audience en la base de datos
ALTER TYPE notification_audience_enum ADD VALUE IF NOT EXISTS 'inactive_users';
ALTER TYPE notification_audience_enum ADD VALUE IF NOT EXISTS 'cart_abandoners';
ALTER TYPE notification_audience_enum ADD VALUE IF NOT EXISTS 'vip_clients';
ALTER TYPE notification_audience_enum ADD VALUE IF NOT EXISTS 'all_active';
...
'reminder', 
'active_users', -- Cambiar a valor válido
true, 
true, 
'0 */4 * * *', -- Cada 4 horas
